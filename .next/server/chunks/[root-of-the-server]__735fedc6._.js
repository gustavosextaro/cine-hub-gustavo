...
"[project]/cinehub/cinehub-main/src/lib/firebase-admin.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$cinehub$2f$cinehub$2d$main$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/cinehub/cinehub-main/src/lib/firebase-admin.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$cinehub$2f$cinehub$2d$main$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$cinehub$2f$cinehub$2d$main$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
async function POST(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$cinehub$2f$cinehub$2d$main$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].collection('analytics').add(event);
...
async function GET() {
    try {
        ...
        const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$cinehub$2f$cinehub$2d$main$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].collection('analytics').get();
        if (snapshot.empty) {
            return Response.json({
                totalPageviews: 0,
                todayPageviews: 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__735fedc6._.js.map